...
import thesisLogo from "../app/Thesis Logo.png";
import thesisWordmark from "../app/Thesis wordmark.png";
...
export function AgencyPage() {
  ...
  return <main className={loaded ? "site is-ready" : "site"}>
    <div className="loader" aria-hidden="true"><Image className="loader-logo" src={thesisLogo} alt="" priority /><span>BUILDING BRANDS THAT MAKE SENSE.</span></div>
    ...
    <footer><div><a className="wordmark" href="#top" aria-label="Thesis home"><Image src={thesisWordmark} alt="Thesis" /></a><p>Brands that make sense.</p></div><div className="footer-nav"><a href="#work">Work</a><a href="#approach">Approach</a><a href="#services">Services</a><a href="#about">About</a></div><div className="footer-meta"><a href="https://instagram.com/thesishq" target="_blank" rel="noreferrer">Instagram / @thesishq ↗</a><a href="https://x.com/thesis_hq" target="_blank" rel="noreferrer">X / @thesis_hq ↗</a><span>Strategy / Identity / Digital</span><span>© 2026 THESIS</span></div></footer>
  </main>;
}
